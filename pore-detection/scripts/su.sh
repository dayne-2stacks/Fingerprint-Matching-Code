...
python3 train.py --patchSize 17 --boundingBoxSize 17 --poreRadius 3 --optimizer SGD --learningRate 0.1 --batchSize 256 --groundTruth dataset --trainingRange 1-10 --validationRange 11-15 --testingRange 16-20  --criteriation BCELOSS --defaultNMS 0 --defaultProb 0.6 --testStartProbability 0.0 --testEndProbability 1.0  --testStartNMSUnion 0.0   --experimentPath experiments/su  --su --device cuda --numberWorkers 4